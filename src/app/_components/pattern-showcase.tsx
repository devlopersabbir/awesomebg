...
//       <div key={gridPatterns[0].id} className="group relative">
//         <div
...
//             activePattern === gridPatterns[0].id
...
//           {/* Pattern style */}
//           <div className="absolute inset-0" style={gridPatterns[0].style} />

//           {/* Badge */}
//           {gridPatterns[0].badge && (
...
//                 <span>{gridPatterns[0].badge}</span>
//               </Badge>
//             </div>
//           )}
...
//                 >
//                   <Eye className="h-3 w-3 mr-1" />
//                   {activePattern === gridPatterns[0].id ? "Hide" : "Preview"}
//                 </Button>
//                 <Button
//                   size="sm"
//                   onClick={(e) => {
